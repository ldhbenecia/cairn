            ...
            {MODELS.map((m) => {
              ...
              return (
                <button
                  ...
                  className={`flex flex-col items-center gap-0.5 rounded-md border px-2 py-2 transition-[border-color,background-color,color,scale] duration-200 ease-out active:scale-[0.96] ${
                    selected
