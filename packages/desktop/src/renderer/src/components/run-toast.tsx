...
export function RunToast({ toast, onClose }: { toast: RunToastData | null; onClose: () => void }) {
  const { t } = useSettings();
  return (
          ...
          (() => {
            ...
            return (
              <motion.div
                ...
                className="glass-panel pointer-events-auto flex w-80 items-center gap-3 rounded-xl border border-hairline bg-surface-1 p-3.5 shadow-2xl shadow-black/40"
              >
                <span
                  className={[
