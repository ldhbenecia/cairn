...
const STRINGS = {
  ko: {
    ...
    'publish.month': '월간',
    'publish.year': '연간',
    'publish.gate.notice': '로그인하면 주간·월간·연간 발행이 열려요',
    'publish.date': '날짜',
    ...
    'nav.reports': '프로젝트',
    'reports.range.week': '주',
    'reports.range.month': '월',
    'reports.range.quarter': '분기',
    'reports.range.year': '연',
  ...
  en: {
    ...
    'publish.year': 'Yearly',
    'publish.gate.notice': 'Sign in to unlock weekly, monthly & yearly publishing',
    'publish.date': 'Date',
