...
const STRINGS = {
  ko: {
    ...
    'prefs.autoPublish.enabled': '자동 발행 사용',
    'prefs.autoPublish.enabledDesc': '매일 정해진 시각에 일지를 자동 발행해요',
  ...
  en: {
    ...
    'prefs.autoPublish.enabled': 'Enable auto-publish',
    'prefs.autoPublish.enabledDesc': 'Publish the worklog automatically at a set time each day',
