...
const STRINGS = {
  ko: {
    ...
    'integrations.noFolder':
      '폴더를 지정하면 발행마다 .md 로 기록돼요 — Obsidian vault 를 지정하면 그대로 연동',
    ...
    'integrations.soon': '준비 중: Apple Notes · iCloud 자동 백업',
  ...
  en: {
    ...
    'integrations.noFolder':
      'Pick a folder and every publish lands as .md — point it at an Obsidian vault to sync',
    ...
    'integrations.soon': 'Coming soon: Apple Notes · iCloud auto-backup',
