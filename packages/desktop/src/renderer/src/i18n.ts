...
const STRINGS = {
  ko: {
    ...
    'billing.free.desc':
      '수집 · Claude 요약 · 로컬 일지 · 노션 1워크스페이스 · 일간~월간 롤업 · 백필 7일',
    ...
    'billing.licenseKey': '라이선스 키',
    'billing.licenseSoon': '결제 오픈 후 입력할 수 있어요',
    'prefs.feedback': '피드백',
  ...
  en: {
    ...
    'billing.free.desc':
      'Collection · Claude summaries · local journal · 1 Notion workspace · daily–monthly rollups · 7-day backfill',
    ...
    'billing.licenseSoon': 'Available once checkout opens',
