...
const STRINGS = {
  ko: {
    ...
    'cmd.achievements': '성과 모으기 (이력서용)',
    'list.achievements': '성과 모으기',
    'achv.title': '성과 모으기',
    'achv.subtitle': '기간을 골라 일지의 Done 항목을 이력서용 마크다운으로 모아요',
  ...
  en: {
    ...
    'cmd.achievements': 'Compile achievements (for resume)',
    'list.achievements': 'Achievements',
    'achv.title': 'Compile achievements',
    'achv.subtitle': 'Pick a range to gather the Done items into resume-ready Markdown',
