...
const STRINGS = {
  ko: {
    ...
    'prefs.sync': '동기화',
    'prefs.sync.account': '계정',
    'prefs.sync.accountDesc': '구글 로그인으로 여러 기기에서 통계를 동기화합니다.',
    'prefs.sync.signInGoogle': 'Google 로 로그인',
    'prefs.sync.signOut': '로그아웃',
    'prefs.sync.notConfigured': '동기화 미설정',
    'prefs.sync.notConfiguredDesc':
      '~/.cairn/.env 에 SUPABASE_URL · SUPABASE_PUBLISHABLE_KEY 를 넣으면 켜집니다.',
    'prefs.billing': '결제',
  ...
  en: {
    ...
    'prefs.sync': 'Sync',
    'prefs.sync.account': 'Account',
    'prefs.sync.accountDesc': 'Sign in with Google to sync stats across devices.',
    'prefs.sync.signInGoogle': 'Sign in with Google',
    'prefs.sync.signOut': 'Sign out',
    'prefs.sync.notConfigured': 'Sync not configured',
    'prefs.sync.notConfiguredDesc':
      'Add SUPABASE_URL and SUPABASE_PUBLISHABLE_KEY to ~/.cairn/.env to enable it.',
