...
const STRINGS = {
  ko: {
    ...
    'drawer.copied': '복사됨',
    'drawer.copyMd': '일지를 Markdown 으로 복사 (Obsidian·메모 붙여넣기용)',
    'drawer.saveMd': '.md 파일로 저장',
    'drawer.savePdf': 'PDF 로 저장',
  ...
  en: {
    ...
    'drawer.copyMd': 'Copy the worklog as Markdown (paste into Obsidian, notes…)',
    'drawer.saveMd': 'Save as a .md file',
    'drawer.savePdf': 'Save as PDF',
