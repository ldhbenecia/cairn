...
const STRINGS = {
  ko: {
    ...
    'prefs.glass': '리퀴드 글래스',
    'prefs.glass.desc': '창·드롭다운을 반투명 유리처럼 — 준비 중',
    'prefs.glass.default': '기본',
    'prefs.glass.on': '리퀴드 글래스',
    'prefs.glass.soon': '준비 중',
    'prefs.language': '언어',
  ...
  en: {
    ...
    'prefs.glass.desc': 'Frosted translucent windows and dropdowns — coming soon',
    'prefs.glass.default': 'Default',
    'prefs.glass.on': 'Liquid Glass',
    'prefs.glass.soon': 'Soon',
