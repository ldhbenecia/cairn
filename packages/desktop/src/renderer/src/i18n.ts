...
const STRINGS = {
  ko: {
    ...
    'account.localDesc': '로그인하면 기록 통계가 기기 간 동기화돼요',
    'account.reSignIn': '다시 로그인',
    'autoConfirm.title': '자동 발행 확인',
    'autoConfirm.run': '발행',
    'autoConfirm.later': '나중에',
    'account.local': '로컬',
    ...
    'publish.week': '주간',
    'publish.month': '월간',
    'publish.gate.notice': '로그인하면 주간·월간 발행이 열려요',
    'publish.date': '날짜',
    'publish.dateHint': '고른 날이 속한 기간',
    'publish.backfill': '누락 일지 채우기',
    'publish.backfillHint': '오늘 포함 최근 며칠의 빠진 일지를 함께 발행할지',
    'publish.backfill.signIn': '로그인하면 최대 7일까지 열려요',
    'publish.backfill.pro': '7일 초과는 Pro 에서 열려요 — 결제 준비 중',
    ...
    'drawer.close': '닫기',
    'drawer.expand': '전체 화면으로 보기',
    'detail.back': '목록으로',
    'detail.properties': '정보',
    ...
    'nav.reports': '프로젝트',
    'reports.timeline': '타임라인',
    'reports.byRepo': '레포별 작업',
    'reports.repoCol': '레포',
    'reports.itemsCol': '항목',
    'reports.activityCol': '기간 활동',
    'reports.noRepo': '기타',
    'reports.back': '뒤로',
    'reports.detail.stats': '항목 {n} · 활동일 {d}',
    'achv.worklogs': '개 일지',
    'achv.copy': '복사',
    'achv.save': '저장',
    'achv.saved': '저장됨',
    ...
    'fail.claude-auth': 'Claude 로그인이 만료됐어요 — 터미널에서 claude 명령으로 다시 로그인하세요',
    'fail.quota': 'Claude 세션/쿼터 한도 — 잠시 후 다시 시도하세요',
    'fail.summarize': 'Claude 요약 실패 — 세션·쿼터를 확인하고 다시 시도하세요',
    ...
    'fail.unknown': '알 수 없는 오류로 중단됐어요 — 다시 시도해 보세요',
    ...
    'prefs.prompts.proLock': 'Pro 기능 — 결제 준비 중',
    'prefs.prompts': '프롬프트',
    'prefs.prompts.model': '요약 모델',
    'prefs.prompts.modelDesc':
      '요약에 쓸 Claude 모델이에요. 어떤 모델이든 발행 속도는 30초 안팎으로 비슷해서, 실제 차이는 문장 품질과 Claude 구독 사용량이에요. 추가 과금은 없어요(내 Claude 로그인 사용). 소요 시간은 발행 결과 화면에 표시돼요.',
    'prefs.prompts.model.default': '기본',
    'prefs.prompts.model.haikuHint': '사용량 최소',
    'prefs.prompts.model.sonnetHint': '균형 · 권장',
    'prefs.prompts.model.opusHint': '최고 품질',
    'prefs.prompts.model.defaultHint': '로그인 모델',
    'prefs.prompts.model.haikuDesc': '구독 사용량을 가장 적게 써요. 일상 일지에 충분한 품질이에요.',
    'prefs.prompts.model.sonnetDesc': '조금 더 정돈된 문장. 사용량 대비 품질 균형이 좋아요.',
    'prefs.prompts.model.opusDesc':
      '가장 정교한 요약 — 롤업·정리 문장에 유리해요. 구독 사용량을 가장 많이 써요.',
    ...
    'prefs.conn.invalid': '인증 실패 — 토큰 갱신 필요',
    'prefs.conn.unreachable': '확인 불가',
  ...
  en: {
    ...
    'account.localDesc': 'Sign in to sync your stats across devices',
    'account.reSignIn': 'Sign in again',
    'autoConfirm.title': 'Confirm auto-publish',
    'autoConfirm.run': 'Publish',
    'autoConfirm.later': 'Later',
    'account.local': 'Local',
    ...
    'recall.title': 'On this day',
    'recall.week': 'A week ago',
    'recall.month': 'A month ago',
    'recall.year': 'A year ago',
    'recall.counts': 'PR {pr} · {commit} commits',
    ...
    'onb.reconfigure': 'Reconfigure connections',
    'onb.nav.start': 'Start',
    'onb.nav.next': 'Next',
    ...
    'publish.gate.notice': 'Sign in to unlock weekly & monthly publishing',
    'publish.date': 'Date',
    'publish.dateHint': 'The period containing this date',
    'publish.backfill': 'Backfill missed days',
    'publish.backfillHint': 'How many recent days to fill in, including today',
    'publish.backfill.signIn': 'Sign in to unlock up to 7 days',
    'publish.backfill.pro': 'Beyond 7 days opens with Pro — checkout coming soon',
    ...
    'cmd.achievements': 'Open projects',
    ...
    'nav.reports': 'Projects',
    'reports.timeline': 'Timeline',
    'reports.byRepo': 'Work by repository',
    'reports.repoCol': 'Repository',
    'reports.itemsCol': 'Items',
    'reports.activityCol': 'Activity',
    'reports.noRepo': 'Other',
    'reports.back': 'Back',
    'reports.detail.stats': 'Items {n} · Active days {d}',
    ...
    'fail.claude-auth':
      'Claude login expired — run the claude command in a terminal to log in again',
    'fail.quota': 'Claude session/quota limit — try again later',
    'fail.summarize': 'Claude summary failed — check your session/quota and retry',
    ...
    'fail.unknown': 'Stopped by an unexpected error — try again',
    ...
    'prefs.prompts.proLock': 'Pro feature — checkout coming soon',
    'prefs.prompts': 'Prompts',
    'prefs.prompts.model': 'Summary model',
    'prefs.prompts.modelDesc':
      'The Claude model used for summaries. Every model publishes in about 30 seconds, so the real difference is prose quality vs. Claude subscription usage. No extra cost — it uses your own Claude login. Time per run is shown on the publish result.',
    'prefs.prompts.model.default': 'Default',
    'prefs.prompts.model.haikuHint': 'Lightest usage',
    ...
    'prefs.prompts.model.haikuDesc':
      'Uses the least subscription quota. Plenty for everyday worklogs.',
    'prefs.prompts.model.sonnetDesc':
      'Slightly more polished prose. Best quality-per-usage balance.',
    'prefs.prompts.model.opusDesc':
      'The most polished summaries — best for rollups and tidy write-ups. Heaviest subscription usage.',
    ...
    'prefs.conn.invalid': 'auth failed — renew token',
    'prefs.conn.unreachable': 'unreachable',
