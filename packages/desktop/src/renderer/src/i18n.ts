...
const STRINGS = {
  ko: {
    ...
    'publish.error.summaryTitle': '요약 생성 실패',
    'publish.error.summaryDesc':
      'Claude 세션이 만료됐거나 사용량 한도에 걸렸을 수 있어요. 세션·쿼터를 확인한 뒤 다시 발행해 주세요.',
    'publish.error.failTitle': '발행 실패',
    'publish.error.failDesc': '작업이 끝까지 완료되지 못했어요. 잠시 후 다시 발행해 주세요.',
    'publish.error.details': '자세히',
    'publish.retry': '다시 발행',
  ...
  en: {
    ...
    'publish.error.summaryTitle': 'Summary failed',
    'publish.error.summaryDesc':
      'Your Claude session may be expired or over its quota. Check the session and quota, then publish again.',
    'publish.error.failTitle': 'Publish failed',
    'publish.error.failDesc': 'The job could not finish. Try publishing again in a moment.',
    'publish.error.details': 'Details',
    'publish.retry': 'Publish again',
