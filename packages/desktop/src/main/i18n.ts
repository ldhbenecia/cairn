...
const STRINGS = {
  ko: {
    ...
    'notify.fail.claude-auth': 'Claude 로그인 만료 — 터미널에서 claude 로 재로그인',
    'notify.fail.quota': 'Claude 세션/쿼터 한도 — 잠시 후 재시도',
    'notify.fail.summarize': 'Claude 요약 실패 — 세션·쿼터 확인 후 재시도',
    ...
    'notify.fail.unknown': '알 수 없는 오류 — 클릭하면 앱에서 확인',
    'notify.connIssueTitle': '연결 인증 실패',
    'notify.connIssueBody': '{services} — 클릭해 연결 탭에서 갱신하세요',
    'notify.cloudExpiredTitle': '클라우드 로그인 만료',
    'notify.cloudExpiredBody': '동기화가 멈춰 있어요 — 클릭해 다시 로그인',
    'cloud.signInFailTitle': '클라우드 로그인 실패',
    'cloud.signInFailBody': '로그인을 완료하지 못했어요. 네트워크를 확인하고 다시 시도해 주세요.',
    'export.saveFailTitle': '저장 실패',
  ...
  en: {
    ...
    'notify.fail.claude-auth': 'Claude login expired — run claude in a terminal to log in again',
    'notify.fail.quota': 'Claude session/quota limit — retry later',
    'notify.fail.summarize': 'Claude summary failed — check session/quota and retry',
    ...
    'notify.fail.unknown': 'Unexpected error — click to check in the app',
    'notify.connIssueTitle': 'Connection auth failed',
    'notify.connIssueBody': '{services} — click to renew in Connections',
    'notify.cloudExpiredTitle': 'Cloud login expired',
    'notify.cloudExpiredBody': 'Sync is paused — click to sign in again',
    'cloud.signInFailTitle': 'Cloud sign-in failed',
    'cloud.signInFailBody': 'Could not complete sign-in. Check your network and try again.',
    'export.saveFailTitle': 'Save failed',
