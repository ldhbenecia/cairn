      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-3.5">
        ...
        <div className="flex items-center gap-2.5">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="group flex items-center gap-1.5 rounded-lg border border-hairline-strong bg-surface-1 px-2.5 py-1.5 text-[13px] text-ink-muted transition-colors hover:border-ink-subtle hover:text-ink"
          >
