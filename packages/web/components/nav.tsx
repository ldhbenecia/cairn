    ...
    <header className="fixed inset-x-0 top-0 z-50 px-4 pt-3 sm:pt-4">
      <div className="mx-auto flex h-12 max-w-5xl items-center justify-between rounded-full border border-hairline bg-canvas/75 pr-1.5 pl-4 shadow-[0_8px_32px_-16px_rgba(0,0,0,0.7)] backdrop-blur-xl">
        ...
        <div className="flex shrink-0 items-center gap-1.5 sm:gap-2.5">
          ...
          <MobileMenu label={c.menu} items={mobileItems} />
          ...
          <a
            ...
            className="group hidden items-center gap-1.5 rounded-full border border-hairline-strong bg-surface-1 px-3 py-1.5 text-[13px] text-ink-muted transition-colors hover:border-ink-subtle hover:text-ink sm:flex"
          >
